const { perguntarEscolha } = require('./chooseCharacter')
...
async function main() {
    console.log("🏎️ Bem-vindo ao Mario Kart Simulador 🏁\n")

    const player1 = await perguntarEscolha(1)
    const player2 = await perguntarEscolha(2)
    
    console.log(`\nJogadores prontos: ${player1.nome} VS ${player2.nome}!\n`)
